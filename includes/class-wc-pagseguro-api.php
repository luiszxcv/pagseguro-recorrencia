...
class WC_PagSeguro_API {
	...
	public function suspendeAtivaAssinatura ($idAssinatura) {
        ...
        try {
			...
			$post_author_id = get_post_field( 'post_author', $idAssinatura );
			update_user_meta( $post_author_id, 'status', $enable ? 1 : 2 );
	...
	public function recorrencePlan ($posted, $xml, $order_id) {
        ...
        */
        ...
        update_post_meta($newAssinaturaRegister, 'active', 0);
		update_post_meta($newAssinaturaRegister, 'aprovation', 1);
